...
export async function insertEstoque( tipo_Movimento,data_Validade,quantidade,preco_Unitario,data , res){
    try{
        const estoque = await Model_estoque.create({tipo_Movimento: tipo_Movimento , data_Validade:data_Validade , quantidade:quantidade , preco_Unitario:preco_Unitario , data_Compra_Venda:data})
